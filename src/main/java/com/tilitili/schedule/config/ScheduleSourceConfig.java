package com.tilitili.schedule.config;
...
@Configuration
@MapperScan(basePackages = {"com.tilitili.schedule.dao"}, sqlSessionTemplateRef  = "scheduleSqlSessionTemplate")
public class ScheduleSourceConfig {
    ...
    public SqlSessionFactory scheduleSqlSessionFactory(@Qualifier("scheduleDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setTypeAliasesPackage("com.tilitili.schedule.entity");
